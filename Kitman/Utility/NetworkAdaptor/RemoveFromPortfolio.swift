...
class RemoveFromPortfolio: APIBase {
    ...
    override var apiPath:String {
        ...
        var path = Configuration.API.Path.RemoveFromPortfolio+"?"
    ...
    override var parameters:[String : Any]? {
        return ["product_id": portfolioID ,"user_id": Utility.getUserID() ]
    }
