//
//  UpdatePortfolioAPI.swift
//  Swagafied
//
//  Created by Amitabha on 07/11/16.
...
class UpdatePortfolioAPI: APIBase {
    ...
    override var apiPath:String {
        ...
        var path = Configuration.API.Path.EditPortfolio+"?"
    ...
    override var parameters:[String : Any]? {
        return ["user_id" : Utility.getUserID() ,"portfolio_id": portfolioID ?? "1", "new_size_id" : sizeID!, "new_price" : price!]
    }
