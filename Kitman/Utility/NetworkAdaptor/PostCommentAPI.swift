...
class PostCommentAPI: APIBase {
    
    var dafaultUserID =  Utility.getUserID()
    var comemnt = "test comment"
    var productID = "12345"
    ...
    override var apiPath:String {
        var path = Configuration.API.Path.PostComment+"?"
    ...
    override var parameters:[String : Any]? {
        return ["comment":comemnt,"product_id":productID,"user_id": Utility.getUserID() ]
    }
